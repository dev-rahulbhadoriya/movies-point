      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Movies Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Movies Point</span>
          </Link>
          {/* mobile menu */} 
          <div id='mobile-nav' className="flex md:order-2">

            <button onClick={() => setDarkMode(!darkMode)} id="theme-toggle" type="button" className="flex items-center mr-2 p-2 text-xs text-gray-700 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg">
              {darkMode ? (<svg id="theme-toggle-dark-icon" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
